...
insert into TEMPERATURE_TIMING  values  (DEFAULT, '2 hours smoke, 1 hour 220, 1 hour smoke', '2-1-1 Ribs');
...
insert into TEMPERATURE_TIMING_DETAIL values (DEFAULT, 1,120, 355.3889, select id from TEMPERATURE_TIMING where name = '2-1-1 Ribs', null);
insert into TEMPERATURE_TIMING_DETAIL values (DEFAULT, 2,120, 377.6111, select id from TEMPERATURE_TIMING where name = '2-1-1 Ribs', null);
insert into TEMPERATURE_TIMING_DETAIL values (DEFAULT, 3,60, 355.3889, select id from TEMPERATURE_TIMING where name = '2-1-1 Ribs', null);
insert into TEMPERATURE_TIMING_DETAIL values (DEFAULT, 4,null, 0, select id from TEMPERATURE_TIMING where name = '2-1-1 Ribs', null);
